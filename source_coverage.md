...
| 3 | `chap-3.tex`; `3-1_DD.tex`; `3-2_CD.tex`; `3-3_EF.tex`; `3-4_DU.tex` | `03-distribution-families.Rmd` | `en/03-distribution-families.Rmd` | 待迁移 |
| 4 | `chap-4.tex`; `4-1_JM.tex`; `4-2_CD.tex`; `4-3_BT.tex`; `4-4_HM.tex`; `4-5_MD.tex`; `4-6_IN.tex` | `04-multiple-random-variables.Rmd` | `en/04-multiple-random-variables.Rmd` | 待迁移 |
| 5 | `chap-5.tex`; `5-1_BC.tex`; `5-2_SR.tex`; `5-3_OS.tex`; `5-4_Co.tex` | `05-random-samples.Rmd` | `en/05-random-samples.Rmd` | 待迁移 |
