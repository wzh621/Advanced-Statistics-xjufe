...
```{r en-ch01-three-toss-pmf, fig.cap="Probability mass for the number of heads in three tosses"}
...
```{r en-ch01-logistic-cdf, fig.cap="The logistic cdf and the step-function reference in the source slides"}
...
```{r en-ch01-logistic-density-figure, echo=FALSE, fig.cap="Interval probability under the logistic density. Source: the original Chapter 1 slides."}
