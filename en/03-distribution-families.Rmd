...
```{r en-chap03-discrete-pmf, fig.width=8, fig.height=4.5, fig.cap='Probability mass functions of Binomial, Poisson, and Geometric distributions'}
...
```{r en-chap03-heavy-tail-comparison, fig.width=7.5, fig.height=4.6, fig.cap='Tail comparison for the standard normal, t(3), and standard Cauchy densities'}
...
```{r en-chap03-source-distribution-map, echo=FALSE, out.width='72%', fig.cap='Map of common distributional relationships from the source slides'}
knitr::include_graphics("images/ch03/fig_distr.png")
```
