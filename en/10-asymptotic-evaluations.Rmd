...
```{r en-chap10-bootstrap-se, fig.cap='Bootstrap distribution and standard error of a sample mean', fig.width=8, fig.height=4.5}
set.seed(1001)
...
```{r en-chap10-huber-loss, fig.cap='Squared loss and Huber loss', fig.width=8, fig.height=4.5}
