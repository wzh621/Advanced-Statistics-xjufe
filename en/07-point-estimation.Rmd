...
```{r en-chap07-exponential-mle, fig.cap='Log likelihood and MLE for an exponential scale parameter', fig.width=8, fig.height=4.5}
set.seed(7301)
theta_true <- 1.1
n <- 300
...
```{r en-chap07-source-mse-bayes, echo=FALSE, out.width='72%', fig.cap='Source-slide comparison of sample-proportion and Bayes-estimator MSE for n=4 and n=400'}
...
```{r en-chap07-rao-blackwell-variance, fig.cap='Simulated variances of the raw and Rao--Blackwellized unbiased estimators (n=20)', fig.width=8, fig.height=4.7}
set.seed(7307)
n_rb <- 20
b_rb <- 20000
...
```{r en-chap07-defect-rate-estimates}
n_defect <- 200
y_defect <- 16
knitr::kable(
  data.frame(
