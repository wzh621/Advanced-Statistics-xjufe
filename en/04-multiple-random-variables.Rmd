...
```{r en-chap04-source-marginal-illustration, echo=FALSE, out.width='57%', fig.cap='Source-slide illustration of a joint density and its marginals'}
...
```{r en-chap04-source-region-411, echo=FALSE, out.width='35%', fig.cap='Integration region for Example 4.1.11 from the source slides'}
...
```{r en-chap04-source-region-412, echo=FALSE, out.width='38%', fig.cap='Triangular support and complement region for Example 4.1.12'}
...
```{r en-chap04-source-conditional-illustration, echo=FALSE, out.width='57%', fig.cap='Source-slide illustration of conditional-density slices'}
...
```{r en-chap04-bivariate-normal-contours, fig.width=7.2, fig.height=4.6, fig.cap='Standard bivariate-normal contours for two correlations'}
...
```{r en-chap04-source-convex-chord, echo=FALSE, out.width='28%', fig.cap='A chord lies above the graph of a convex function (source slide)'}
...
```{r en-chap04-source-jensen-tangent, echo=FALSE, out.width='30%', fig.cap='Supporting-line interpretation of Jensen’s inequality (source slide)'}
