...
```{r chap03-discrete-pmf, fig.width=8, fig.height=4.5, fig.cap='二项、Poisson 与几何分布的概率质量函数'}
...
```{r chap03-heavy-tail-comparison, fig.width=7.5, fig.height=4.6, fig.cap='标准正态、t(3) 与标准 Cauchy 密度的尾部比较'}
...
```{r chap03-source-distribution-map, echo=FALSE, out.width='72%', fig.cap='原课件中的常见分布关系图'}
