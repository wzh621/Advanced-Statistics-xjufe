...
```{r chap08-source-errors, echo=FALSE, out.width='64%', fig.cap='原课件中的假设检验决策与两类错误示意'}
...
```{r chap08-binomial-power, fig.cap='两个二项检验的功效函数', fig.width=8, fig.height=4.5}
...
```{r chap08-source-binomial-power, echo=FALSE, out.width='62%', fig.cap='原课件中的二项功效函数图'}
...
```{r chap08-source-ump, echo=FALSE, out.width='42%', fig.cap='原课件中的 UMP 概念示意'}
...
```{r chap08-source-pvalue, echo=FALSE, out.width='42%', fig.cap='原课件中的 p 值尾概率示意'}
...
```{r chap08-power-surface, fig.cap='双侧 z 检验的功效随标准化效应量与样本量的变化（alpha=0.05）', fig.width=8, fig.height=5.1}
alpha <- 0.05
...
```{r chap08-pvalue-simulation, fig.cap='双侧 z 检验在原假设与备择假设下的 p 值分布', fig.width=8, fig.height=4.5}
set.seed(8308)
b_pvalue <- 20000
n_pvalue <- 25
effect_pvalue <- 0.4
