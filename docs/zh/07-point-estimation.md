...
<img src="07-point-estimation_files/figure-html/chap07-exponential-mle-1.png" alt="指数尺度参数的对数似然与最大似然估计" width="90%" />
<p class="caption">(\#fig:chap07-exponential-mle)指数尺度参数的对数似然与最大似然估计</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ch07/mse-bayes-comparison.png" alt="原课件中样本比例与 Bayes 估计量的 MSE 比较（n=4 与 n=400）" width="72%" />
<p class="caption">(\#fig:chap07-source-mse-bayes)原课件中样本比例与 Bayes 估计量的 MSE 比较（n=4 与 n=400）</p>
</div>
