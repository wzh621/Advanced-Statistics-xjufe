...
<img src="06-data-reduction_files/figure-html/chap06-ancillary-range-1.png" alt="不同位置参数下，均匀样本极差具有相同分布" width="90%" />
<p class="caption">(\#fig:chap06-ancillary-range)不同位置参数下，均匀样本极差具有相同分布</p>
</div>
