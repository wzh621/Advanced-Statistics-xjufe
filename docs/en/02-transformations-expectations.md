...
<img src="../images/ch02/fig_2-1-1.png" alt="Source-slide illustration of the multiple branches of the sine-squared transformation" width="58%" />
<p class="caption">(\#fig:en-chap02-sine-square-source-figure)Source-slide illustration of the multiple branches of the sine-squared transformation</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="02-transformations-expectations_files/figure-html/en-chap02-sine-square-simulation-1.png" alt="Simulated and theoretical distributions of Y=sin²(X)" width="90%" />
<p class="caption">(\#fig:en-chap02-sine-square-simulation)Simulated and theoretical distributions of Y=sin²(X)</p>
</div>
