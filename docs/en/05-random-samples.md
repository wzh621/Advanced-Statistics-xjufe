...
<img src="05-random-samples_files/figure-html/en-chap05-exponential-board-simulation-1.png" alt="Theoretical and simulated probabilities that every board lasts more than two years" width="90%" />
<p class="caption">(\#fig:en-chap05-exponential-board-simulation)Theoretical and simulated probabilities that every board lasts more than two years</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="05-random-samples_files/figure-html/en-chap05-uniform-order-statistics-1.png" alt="Sampling distributions of selected order statistics from a uniform population" width="90%" />
<p class="caption">(\#fig:en-chap05-uniform-order-statistics)Sampling distributions of selected order statistics from a uniform population</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="05-random-samples_files/figure-html/en-chap05-uniform-maximum-limit-1.png" alt="The scaled uniform-sample maximum approaches Exp(1)" width="90%" />
<p class="caption">(\#fig:en-chap05-uniform-maximum-limit)The scaled uniform-sample maximum approaches Exp(1)</p>
</div>
